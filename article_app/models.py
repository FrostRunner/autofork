# -*- coding: utf-8 -*-
from __future__ import unicode_literals, unicode_literals
...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('article_app:category', args=[self.slug])
...
class Comment(models.Model):
    ...
    def get_reply_link(self):
        return reverse('article_app:comment_reply', args=[self.article_id, self.id])
