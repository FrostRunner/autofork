...
from .models import Article, Category, Comment, TemplateSnippet


def article_app_sidebar(request):
    ctx = {}
    ...
    ctx['aside_comment_list'] = \
        commensts.extra(select={'_article_slug': 'article_app_article.slug'})[:5]
